...
export default function RestaurantFuncionarios({ role }: Props) {
  ...
  async function criarFuncionario(e: React.FormEvent) {
    ...
    const cpfFinal = cpf.replace(/\D/g, "");

    if (cpfFinal.length !== 11) {
      setAlert({
        message: "Informe um CPF completo.",
        type: "error",
      });
      return;
    }
      ...
      <div className="flex justify-between text-start my-5 flex-col gap-6 lg:flex-row lg:gap-0">
        ...
        <div className="flex items-center">
          <button
            ...
            className={`flex items-center gap-4 text-sm font-semibold px-5 py-2.5 rounded-md transition-all ${
              role === "gerente"
          ...
          >
            <Lock
              className={`w-4 h-4 ${
                role === "gerente" ? "text-[#676767]" : "text-white"
              }`}
            />
            {hasRolePassword
                ...
                >
                  ...
                  <div className="flex flex-col px-5 py-5 pt-3 text-center w-full h-full">
                    ...
                    <button
                      ...
                      disabled={
                        !hasRolePassword ||
                        (role === "gerente" && cargo.tipo === "gerente")
                      }
                      className={`mt-4 text-sm font-semibold py-2 rounded-md transition-all
    ${
      hasRolePassword && !(role === "gerente" && cargo.tipo === "gerente")
        ? "bg-(--color-primary) hover:bg-(--color-secondary) cursor-pointer text-white"
        : "bg-[#E5E5E5] cursor-not-allowed text-[#676767]"
    }
  `}
      ...
      `}
            ...
            >
              {loading ? (
                ...
                // <div className="rounded-lg bg-white flex flex-col items-center shadow-sm col-span-4 py-5">
                ...
                <div className="flex flex-col items-center justify-center gap-3 py-15 w-full border border-gray-200 rounded-md col-span-full">
                  <div className="relative w-30 h-16">
                    <Image
                      src="/sem_funcionarios2.png"
                      alt="Banner do restaurante"
...
{/* -- */}
                ...
                <div className="flex flex-row items-center gap-2">
                  <button
                    ...
                    className="cursor-pointer rounded-lg border border-[#dfe4eb] bg-white px-3 py-2 text-sm font-medium text-[#536078] hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40 transition"
                  >
                    Anterior
                  </button>
                      ...
                      (_, i: number) => {
                        ...
                        return (
                          <button
                            ...
                            className={`h-9 min-w-9 cursor-pointer rounded-lg px-3 text-sm font-medium outline-none ${
                      page === pageNumber
                        ? "bg-[#1b325f] text-white"
                        : "border border-[#dfe4eb] bg-white text-[#536078] hover:bg-gray-100 transition"
                    }`}
        ...
        {showModal && (
          ...
          >
            <form
              ...
              className="bg-white rounded-lg shadow-sm p-10 py-5 h-fit transition-all border border-gray-100 flex flex-col"
            >
              <h1 className="font-semibold text-[22px] text-[#19274b]">
                    ...
                    {cargos.map((cargo) => {
                      ...
                      return (
                        <button
                          type="button"
                          key={cargo.tipo}
                           disabled={cargoDesabilitado}
                          onClick={() => toggleCargo(cargo.tipo)}
                          className={`relative flex gap-3 border rounded-md p-3 items-center transition-all ${
  cargoDesabilitado
    ? "bg-[#E5E5E5] border-[#D5D5D5] opacity-60 cursor-not-allowed"
    : cargosSelecionados.includes(cargo.tipo)
      ? "bg-[#EAF2FD] border-[#a7c3e2] cursor-pointer"
      : "bg-gray-200 border-gray-300 opacity-60 cursor-pointer"
}`}
                        >
              ...
              {!pinModal.pin ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full border border-gray-300 py-2 rounded-md hover:bg-gray-100 transition cursor-pointer flex items-center justify-center gap-2"
                  >
                    {copiedPin ? (
                      <>
                        <Copy className="w-5 h-5 text-[#19274b]" />
                        <span>Copiado</span>
                      </>
                    ) : (
                      <>
